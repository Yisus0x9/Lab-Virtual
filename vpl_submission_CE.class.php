...
class mod_vpl_submission_CE extends mod_vpl_submission {
    ...
    */
    ...
    public const SCRIPT_NAME = [
        ...
        'vpl_remote_lab.sh' => 'remote_lab',
        'vpl_generate_testbench.sh' => 'generate_testbench',
    ];
    ...
    /**
     * Identify the remote lab execution type.
     */
    const TREMOTELAB = 4;
    /**
     * Identify the generate testbench execution type.
     */
