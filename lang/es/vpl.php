...
$string['copy'] = 'Copiar';
$string['copy_help'] = 'Copia esta entrega en el editor propio (abre una nueva ventana)';
...
$string['debug_help'] = 'Permite a los estudiantes depurar su código en el editor. Los profesores siempre pueden depurar cualquier entrega.';
...
$string['evaluate_help'] = 'Permite a los estudiantes evaluar automáticamente su entrega. Los profesores siempre pueden evaluar cualquier entrega.';
...
$string['run'] = 'Ejecutar';
$string['run_help'] = 'Permite a los estudiantes ejecutar su código en el editor. Los profesores siempre pueden ejecutar cualquier entrega.';
...
$string['remote_lab'] = 'Laboratorio remoto';
$string['remote_lab_help'] = 'Permite a los estudiantes iniciar el laboratorio remoto. Los profesores siempre pueden usar esta acción.';
$string['remotelabbing'] = 'Ejecutando laboratorio remoto';
$string['remote_lab_host'] = 'IP / Host del servidor';
$string['remote_lab_user'] = 'Usuario';
$string['remote_lab_pass'] = 'Contraseña';
$string['remote_download'] = 'Descargar del remoto';
$string['remote_download_help'] = 'Descarga un archivo generado en la sesión del laboratorio remoto hacia los ficheros del alumno. Los profesores siempre pueden usar esta acción.';
$string['downloadingremote'] = 'Descargando del remoto';
$string['remote_download_file'] = 'Archivo(s) remoto(s): archivo1,archivo2 o ruta:archivo1,archivo2';
$string['remote_download_fields_required'] = 'El servidor, usuario, contraseña y el archivo remoto son obligatorios para descargar del laboratorio remoto.';
$string['remote_download_invalid'] = 'Formato de archivo inválido. Usa archivo1,archivo2 o ruta:archivo1,archivo2 (sin elementos vacíos).';
$string['remote_download_failed'] = 'Falló la descarga remota: {$a}';
