...
class mod_vpl_executionoptions_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('selectyesno', 'remote_lab', get_string('remote_lab', VPL));
        $mform->setDefault('remote_lab', $instance->remote_lab);
        $mform->addHelpButton('remote_lab', 'remote_lab', VPL);
        $mform->addElement('selectyesno', 'generate_testbench', get_string('generate_testbench', VPL));
        $mform->setDefault('generate_testbench', $instance->generate_testbench);
        $mform->addHelpButton('generate_testbench', 'generate_testbench', VPL);
...
if ($fromform = $mform->get_data()) {
    if (isset($fromform->saveoptions)) {
        ...
        $instance->remote_lab = $fromform->remote_lab;
        $instance->generate_testbench = $fromform->generate_testbench;
